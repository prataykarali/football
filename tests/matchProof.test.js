...
describe('MatchProofService', () => {
  ...
  describe('Engagement fingerprint', () => {
    it('should be deterministic for same engagement data', async () => {
      ...
      const fp1 = await service.engagementFingerprint(engagement);
      const fp2 = await service.engagementFingerprint(engagement);
    ...
    it('should differ for different engagement data', async () => {
      ...
      const fp1 = await service.engagementFingerprint(engagement1);
      const fp2 = await service.engagementFingerprint(engagement2);
  ...
  describe('Verification', () => {
    it('should return true for matching proof', async () => {
      ...
      const proofId = await service.generateProofId(input);
      const isValid = await service.verify(input, proofId);
    ...
    it('should return false for non-matching proof', async () => {
      ...
      const isValid = await service.verify(input, '0xdeadbeef');
