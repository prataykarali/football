...
export const highlightsPageMethods = {
  ...
  _renderHighlights(container, highlights) {
    setHTML(container, highlights.map((h, i) => {
      ...
      <div class="highlight-card highlight-card--${safeType}" data-yt="${id}" data-idx="${i}" style="opacity:1;transform:none;">
        <div class="highlight-card__video-wrap" tabindex="0" role="button" aria-label="Play highlight: ${title}" style="position:relative;width:100%;height:180px;overflow:hidden;border-radius:var(--radius-md) var(--radius-md) 0 0;background:#000;cursor:pointer;">
